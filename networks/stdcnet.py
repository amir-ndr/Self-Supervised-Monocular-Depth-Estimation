...
import math
from utils_stdc.nn.mynn import Norm2d
import numpy as np
...
class STDCNet1446(nn.Module):
    def __init__(self, base=64, layers=[4,5,3], block_num=4, type="cat", num_classes=1000, dropout=0.20,
                 pretrain_model='networks/pretrained_models/STDCNet1446_76.47_2.tar',
        ...
        if type == "cat":
            ...
            block = AddBottleneck
        self.num_ch_enc = np.array([32, 64, 256, 512, 1024])
...
class STDCNet813(nn.Module):
    def __init__(self, base=64, layers=[2,2,2], block_num=4, type="cat", num_classes=1000, dropout=0.20,
                 pretrain_model='networks/pretrained_models/STDCNet813_73.91.tar',
                 use_conv_last=False, norm_layer=nn.BatchNorm2d):
