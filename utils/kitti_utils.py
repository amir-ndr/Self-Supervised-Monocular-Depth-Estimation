...
# https://github.com/nianticlabs/monodepth2/blob/master/export_gt_depth.py
...
def export_gt_depths(data_path, split):
    ...
    print("Exporting ground truth depths for {}".format(split))
